 ...
 *  @author Tom
 */
public class VariableOutput extends NodeOutput {
    
    public VariableOutput(Node parent, String name, String description) {
        super( parent,  name, DataType.VARIABLE, description);
    }
